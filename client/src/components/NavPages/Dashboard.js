            ...
            <div className="grid sm:grid-cols-12 grid-cols-1 overflow-auto overscroll-contain">
                <div className="col-span-2 sticky top-0 z-50">
                    ...
                    <div className="sm:h-screen h-full text-center bg-gray-900 sm:pb-96 pb-0 flex flex-row sm:flex-col justify-around sm:justify-start">
                        ...
                        <Link to="/account" className="hover:text-blue-300 py-3 cursor-pointer text-white sm:text-white flex gap-2 flex-wrap sm:gap-2 justify-start px-2"><RiAccountBoxFill className="text-white text-2xl" /><div className="sm:block ">Account</div></Link> 

                        <Link to="/main" className="sm:bg-gray-700  py-3 cursor-pointer text-blue-300 flex gap-2 flex-wrap sm:gap-2 justify-start px-2"><BiMessageAltAdd className=" text-blue-300 text-2xl"/><div className="sm:block ">Dashboard</div></Link>
